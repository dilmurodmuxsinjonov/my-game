...
### 13.4. Butun O'yin Boyicha Barcha Buyumlar, Materiallar va O'ljalar Master Katalogi (Comprehensive Master Item Catalog & Drop Matrix)

O'yindagi barcha ashyolar, tabiiy qazilmalar, ekinlar, tayyor taomlar, harbiy aslahalar, mob o'ljalari va afsonaviy relikviyalar quyidagi kategoriyalarga ajratilgan holda ularning paydo bo'lish manbalari (konchilik, dehqonchilik, ovchilik, hunarmandchilik dastgohlari yoki daxma sandiqlari) bilan qat'iy tizimlashtirilgan:

#### 13.4.1. Toshlar, Rudalar, Minerallar va Qimmatbaho Javohirlar (Stones, Minerals, Ores & Gems)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_COBBLESTONE` | Dala toshi (Cobblestone) | Tabiiy Tosh | Tier 1 (Common) | Yer yuzasi qoyalari va $Y \ge -30\text{m}$ tosh qatlamini oddiy tosh cho'kich bilan qazishda 100% tushadi. | Poydevor qurish, o'choq, past darajali devorlar va tosh qurollar yasash. |
| `ITEM_GRANITE` | Qattiq Granit (Granite) | Magmatik Tosh | Tier 2 (Fine) | Tog'li biomlar va $-30\text{m} \dots -120\text{m}$ qatlamlardan temir cho'kich bilan qazib olinadi. | Qal'a devorlari, mustahkam poydevorlar va tegirmon toshlari tayyorlash. |
| `ITEM_LIMESTONE` | Qatlamli Ohaktosh (Limestone) | Cho'kindi Tosh | Tier 1 (Common) | Daryo bo'ylari va tekislik g'orlaridan tosh yoki temir cho'kich bilan oson qazib olinadi. | O'choqda kuydirib qurilish ohak qorishmasi (mortar) olish va silliq bloklar yo'nish. |
| `ITEM_MARBLE` | Oq Marmar (White Marble) | Metamorfik Tosh | Tier 3 (Masterwork) | Chuqur tog' daxmalari va $-100\text{m} \dots -220\text{m}$ marmar tomirlaridan po'lat cho'kich bilan ajratiladi. | Buyuk Sobor, saroy ustunlari, bezak haykallari va shohona me'morchilik. |
| `ITEM_BASALT` | Qora Vulqon Bazalti (Basalt) | Magmatik Qattiq | Tier 3 (Masterwork) | Vulqonli hududlar va $-180\text{m} \dots -280\text{m}$ magmatik qatlamlardan po'lat cho'kich bilan olinadi. | Olovbardosh domna pechlari va portlashga chidamli istehkom bloklari. |
| `ITEM_OBSIDIAN` | Qora Shishasimon Obsidian | Vulqon Shishasi | Tier 4 (Legendary) | Lava va yerosti daryolari to'qnashgan $-250\text{m} \dots -350\text{m}$ chuqurlikdan mitril cho'kich bilan olinadi. | Eng o'tkir jarrohlik pichoqlari, o'q uchlari va runik plitalar yaratish. |
| `ITEM_CLAY` | Qizil Loy / Gil (Raw Clay) | Cho'kindi Mineral | Tier 1 (Common) | Daryo qirg'oqlari, ko'l tubi va botqoqliklardan belkurak bilan qazib olinadi. | Kulolchilik xumdoni, pishgan g'isht, koshinlar va don saqlash xumlari. |
| `ITEM_COAL` | Toshko'mir (Mineral Coal) | Yoqilg'i Minerali | Tier 1 (Common) | $-10\text{m} \dots -150\text{m}$ chuqurlikdagi qora ko'mir tomirlaridan har qanday cho'kich bilan qaziladi. | Xumdonlar, metallurgiya o'choqlari va mash'alalar uchun uzoq yonuvchi yoqilg'i. |
| `ITEM_ORE_IRON` | Qizil Temir Rudasi (Iron Ore) | Metall Rudasi | Tier 2 (Fine) | $-20\text{m} \dots -180\text{m}$ oraliqdagi ruda qatlamlaridan tosh yoki temir cho'kich bilan olinadi. | Eritish xumdonida eritib temir quymasi va qurol-aslahalar ishlab chiqarish. |
| `ITEM_ORE_COPPER` | Tug'ma Mis Rudasi (Copper Ore)| Rangli Metall | Tier 1 (Common) | Yer yuzasidagi qizil qoyalar va $-5\text{m} \dots -80\text{m}$ chuqurlikdan oson qazib olinadi. | Qalay bilan qotishma qilib bronza quyish va maishiy idishlar tayyorlash. |
| `ITEM_ORE_TIN` | Oq Qalay Rudasi (Tin Ore) | Rangli Metall | Tier 1 (Common) | Daryo yaqinidagi tosh qatlamlar va $-15\text{m} \dots -70\text{m}$ chuqurlikdan qazib olinadi. | Mis bilan birga 1:3 nisbatda eritilib mustahkam bronza quymasi hosil qilinadi. |
| `ITEM_ORE_LEAD` | Og'ir Qo'rg'oshin Rudasi | Og'ir Metall | Tier 2 (Fine) | Chuqur shaxtalardan ($-60\text{m} \dots -160\text{m}$) temir cho'kich bilan qazib olinadi. | Qamal arbaleti og'ir o'qlari, suv quvurlari va titratuvchi runa plitalari. |
| `ITEM_ORE_SILVER` | Sof Kumush Rudasi (Silver Ore)| Qimmatbaho Metall| Tier 3 (Masterwork) | $-80\text{m} \dots -220\text{m}$ oraliqdagi yaltiroq tomirlardan temir cho'kich bilan olinadi. | Qirollik tangalari zarb qilish, zargarlik buyumlari va ruhoniylar idishlari. |
| `ITEM_ORE_GOLD` | Oltin Qumi va Rudasi (Gold Ore)| Qimmatbaho Metall| Tier 3 (Masterwork) | Daryo qumlarini yuvish yoki $-120\text{m} \dots -280\text{m}$ chuqur oltin tomirlaridan olinadi. | Savdo xazinasi tangalari, diplomatik sovg'alar va sehrli katalizatorlar. |
| `ITEM_SULFUR` | Sariq Oltingugurt (Sulfur) | Yonuvchi Mineral | Tier 2 (Fine) | Vulqonli g'orlar, geotermal buloqlar va $-90\text{m}$ qatlamlardan qazib olinadi. | Alkimyoviy olovli qorishmalar, katapulta qoramoylari va o't yoqish toshlari. |
| `ITEM_GEM_LAPIS` | Moviy Lapislazuli (Lapis Lazuli)| Magik Javohir | Tier 2 (Fine) | Chuqur ko'k tomirli g'orlardan ($-50\text{m} \dots -180\text{m}$) qazib ajratiladi. | Runalarni o'yib yozish stoli, bo'yoqchilik va sehrgarlar minorasi tajribalari. |
| `ITEM_GEM_RUBY` | Qizil Yoqut (Ruby Crystal) | Qimmatbaho Tosh | Tier 3 (Masterwork) | $-150\text{m} \dots -300\text{m}$ chuqur granit yoriqlaridan nodir holda 3% ehtimol bilan tushadi. | Hukmdor tojlari, olov sehri artefaktlari va qimmatbaho qirollik uzuklari. |
| `ITEM_GEM_EMERALD` | Yashil Zumrad (Emerald) | Qimmatbaho Tosh | Tier 3 (Masterwork) | Tog'oldi daxmalari va $-100\text{m} \dots -240\text{m}$ slanes tomirlaridan qazib olinadi. | Savdogarlar gildiyasi bilan imtiyozli shartnomalar va diplomatik nishonlar. |
| `ITEM_GEM_DIAMOND` | Oliy Navli Olmos (Diamond) | Qimmatbaho Tosh | Tier 4 (Legendary) | $-220\text{m} \dots -350\text{m}$ eng chuqur magmatik qatlamlardan 1.5% nodir ehtimol bilan tushadi. | Oliy darajali III runalarni charxlash, olmos tig'li asboblar va shohona taxt. |
| `ITEM_GEM_SAPPHIRE` | Moviy Safir (Blue Sapphire) | Qimmatbaho Tosh | Tier 3 (Masterwork) | Yerosti sovuq muz g'orlari va $-140\text{m} \dots -260\text{m}$ qatlamlardan topiladi. | Suv osti va sovuqdan saqlovchi runalarni faollashtirish hamda tumorlar. |
| `ITEM_ORE_MITHRIL` | Qadimiy Ko'k Mitril Rudasi | Afsonaviy Metall | Tier 4 (Legendary) | Faqat $-300\text{m} \dots -350\text{m}$ bedrock ustidagi eng xavfli zonalardan olmos cho'kich bilan olinadi. | Sinmas va og'irliksiz afsonaviy elita qurollari hamda ritsarlar aslahalari. |

#### 13.4.2. Qurilish Materiallari va Konstruksiyalar Katalogi (Building Materials & Structures)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_WOOD_LOG_PINE` | Qarag'ay Yog'ochi Xodasi | Xom Yog'och | Tier 1 (Common) | Tayga va ignabargli o'rmonlardagi qarag'ay daraxtini bolta bilan kesganda 100% tushadi. | Boshlang'ich yog'och devorlar, ustunlar, gulxan yoqilg'isi va taxta tilish. |
| `ITEM_WOOD_LOG_OAK` | Qattiq Eman Xodasi (Oak Log) | Qattiq Yog'och | Tier 2 (Fine) | Zich tekislik o'rmonlaridagi ko'p yillik emanlarni temir bolta bilan kesish orqali olinadi. | Og'ir yuk ko'taruvchi konstruksiyalar, shahar darvozalari va mustahkam sandiqlar. |
| `ITEM_WOOD_LOG_BIRCH` | Oq Qayin Xodasi (Birch Log) | Yengil Yog'och | Tier 1 (Common) | Daryo bo'yi qayinzorlaridan bolta bilan kesib tayyorlanadi. | Ichki mebellar, duradgorlik buyumlari, tutunsiz quruq o'tin va aravachalar. |
| `ITEM_WOOD_LOG_YEW` | Qora Archa Xodasi (Yew Log) | Elastik Yog'och | Tier 3 (Masterwork) | Qalindaryo vodiylari va tog' yonbag'irlaridagi kamyob archazorlardan yig'iladi. | Uzoqqa otuvchi professional Uels kamonlari va arbalet qismlari yasash. |
| `ITEM_WOOD_PLANK` | Ishlangan Yog'och Taxta | Tilangan Yog'och | Tier 1 (Common) | Duradgorlik dastgohida 1 dona xodani tilish orqali 4 dona taxta olinadi. | Xonadon pollari, shiftlar, devor qoplamalari, eshiklar va aravalar. |
| `ITEM_WOOD_BEAM` | Yuk Ko'taruvchi Yog'och Brus | Konstruksiya Bloki | Tier 2 (Fine) | Suv tegirmoni sawmilida eman xodalarini yo'nib, temir mixlar bilan tayyorlanadi. | Katta zallar, ko'priklar, minoralar va shaxta shiftini mustahkamlovchi tirgovichlar. |
| `ITEM_THATCH_BUNDLE` | Somon To'plami (Thatch) | Tom Yopgich | Tier 1 (Common) | Bug'doy va arpa o'rimidan keyin poyalarni yig'ishtirib bog'lash orqali olinadi. | Qishloq kulbalari tomi, molxonalar to'shamasi va loy g'isht mustahkamlagichi. |
| `ITEM_MORTAR` | Qurilish Ohak Qorishmasi | Bog'lovchi Modda | Tier 2 (Fine) | Kuydirilgan ohaktosh kukunini daryo qumi va suv bilan qorg'onda qorishtirib olinadi. | Tosh g'ishtlarni bir-biriga yopishtirish, mustahkam devorlar va gumbazlar tiklash. |
| `ITEM_STONE_BRICK` | Silliqlangan Tosh Blok | Qurilish Bloki | Tier 2 (Fine) | Tosh yo'nuvchi ustaxonasida dala toshini ohak qorishmasi bilan presslab yo'niladi. | Qal'a devorlari, mudofaa minoralari, qasr xonalari va tosh ko'priklar. |
| `ITEM_CLAY_BRICK` | Pishirilgan Qizil G'isht | Keramik Blok | Tier 2 (Fine) | Loy qolipga quyilib, kulol xumdonida 10 soat davomida pishirib qotiriladi. | Nonvoyxona pechlari, uy kaminlari, mo'rilar va issiq xonadon devorlari. |
| `ITEM_MARBLE_COLUMN` | O'yilgan Marmar Ustun | Bezak Bloki | Tier 3 (Masterwork) | Usta tosh yo'nuvchi tomonidan oq marmar monolitidan o'yib sayqallanadi. | Buyuk Sobor, saroy taxt zali va g'alaba monumentlarining asosiy ustunlari. |
| `ITEM_GLASS_PANE` | Qalin Shisha Oyna Paneli | Shaffof Material | Tier 2 (Fine) | Shisha pishirish xumdonida sof kvars qumi va kulni $1200^\circ\text{C}$ da eritib yoyiladi. | Shahar binolari derazalari, botanika issiqxonalari va kimyo idishlari. |
| `ITEM_IRON_BARS` | Temir Panjara Paneli | Mudofaa Bloki | Tier 2 (Fine) | Temirxonada 2 dona temir quymasini qizdirib bolg'alash orqali yasaladi. | Qamoqxona kameralari, qasr tuynuklari, kanalizatsiya to'siqlari va qamal panjarasi. |
| `ITEM_ROOF_SHINGLES` | Tom Sopol Koshinlari (Tiles) | Tom Yopgich | Tier 2 (Fine) | Kulol ustaxonasida loydan yupqa shakllar kesilib, xumdonda sirlanib pishiriladi. | Shahar uylari tomi (olovga 100% chidamli va yomg'ir o'tkazmaydi). |
| `ITEM_FORTIFIED_PORTCULLIS`| Ko'tarma Temir Panjara Darvoza| Qamal Darvozasi | Tier 3 (Masterwork) | Qal'a duradgorxonasida eman xodalari va temir plastinalarni biriktirib quyiladi. | Qasr bosh darvozasini qamal qo'chqorlari va dushman to'dalaridan to'liq yopish. |

#### 13.4.3. Xomashyo va Qayta Ishlangan Sanoat Materiallari (Raw & Industrial Materials)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_INGOT_CAST_IRON` | Qora Cho'yan Quymasi | Xom Metall | Tier 1 (Common) | Past haroratli bloomery xumdonida temir rudasini yog'och ko'miri bilan eritib olinadi. | Qozonlar, og'ir o'choq panjaralari, ibtidoiy zanjirlar va mixlar quyish. |
| `ITEM_INGOT_IRON` | Tozalangan Temir Quyma | Standart Metall | Tier 2 (Fine) | Temirchilik o'chog'ida cho'yanni qayta qizdirib, shlakdan tozalash orqali olinadi. | Standart qilichlar, nayzalar, dubulg'alar, zanjir sovutlar va barcha asboblar. |
| `ITEM_INGOT_BRONZE` | Bronza Quymasi (Bronze Ingot)| Qotishma Metall | Tier 1 (Common) | Eritish pechida 3 qism mis va 1 qism qalayni aralashtirib eritiladi. | Mustahkam jangovar boltalar, bronza tangali sovutlar va cherkov qo'ng'iroqlari. |
| `ITEM_INGOT_STEEL` | Zich Po'lat Quymasi (Steel) | Oliy Sifat Metall | Tier 3 (Masterwork) | Domna pechida temir quymasini toshko'mir va yuqori bosimli havo bilan toblab olinadi. | Ritsarlik uzun qilichlari, to'liq po'lat sovutlar, og'ir arbalet detallari. |
| `ITEM_INGOT_DAMASCUS` | Qatlamli Damashq Po'lati | Afsonaviy Qotishma| Tier 4 (Legendary) | Saroy tigel xumdonida yuqori uglerodli po'latni 120 qatlam qilib buklab bolg'alanadi. | Eng o'tkir sinmas shohona shamshirlar va imperator sovg'alari. |
| `ITEM_INGOT_SILVER` | Toza Kumush Quyma (Silver) | Zargarlik Metalli | Tier 3 (Masterwork) | Kumush rudasini eritish xumdonida eritib, qoliplarga quyish orqali olinadi. | Davlat g'aznasi kumush tangalari, aristokratlar qasri idishlari va uzuklar. |
| `ITEM_INGOT_GOLD` | Sof Oltin Quyma (Gold Ingot) | Xazina Metalli | Tier 3 (Masterwork) | Yuvilgan oltin qumini kichik tigelda eritib yombilar holiga keltiriladi. | Buyuk savdo shartnomalari to'lovi, toj va taqinchoqlar hamda sehrli nishonlar. |
| `ITEM_INGOT_MITHRIL` | Afsonaviy Moviy Mitril Quyma | Afsonaviy Metall | Tier 4 (Legendary) | Saroy domna pechida mitril rudasini sof olov kvarsi oqimi ostida eritib olinadi. | Og'irligi paxtadek yengil, biroq po'latdan 5 barobar mustahkam qurol va zirhlar. |
| `ITEM_FLAX_FIBER` | Xom Zig'ir Tolasi (Flax Fiber)| O'simlik Tolasi | Tier 1 (Common) | Dala ekin maydonlaridan yig'ilgan zig'ir poyalarini quritib, titish orqali olinadi. | Ip yigirish urchug'ida ip o'rash, kamon tirgak iplari va xaltalar tikish. |
| `ITEM_FABRIC_LINEN` | To'qilgan Kanop Zig'ir Mato | To'qima Mato | Tier 1 (Common) | To'quv dastgohida zig'ir iplarini to'qish orqali olinadi. | Fuqarolar ko'ylaklari, yozgi kiyimlar, jarohat bog'ichlari va kema yelkanlari. |
| `ITEM_RAW_WOOL` | Qirqilgan Xom Qo'y Juni | Hayvonot Mahsuloti | Tier 1 (Common) | Shahar chorva qo'tonidagi qo'ylarni maxsus jun qaychisi bilan qirqib olinadi. | Yuvilib tozalangach movut mato va qishki issiq kiyimlar to'qishda ishlatiladi. |
| `ITEM_FABRIC_WOOL` | Issiq Jun Movut Mato | Zich Mato | Tier 2 (Fine) | To'quv dastgohida tozalangan jun iplarini qalin bosib to'qish orqali olinadi. | Qishki paxtali jiletlar (gambeson), qishki choponlar va og'ir parda matolari. |
| `ITEM_RAW_HIDE` | Qoramol va Kiyik Xom Terisi | Xom Teri | Tier 1 (Common) | Qassobxonada mol yoki o'rmonda kiyik so'yilganda 100% tushadi. | Teri oshlash bochkalarida eman po'stlog'i bilan ishlov berish uchun xomashyo. |
| `ITEM_LEATHER_CURED` | Oshlangan Qattiq Charm | Ishlangan Charm | Tier 2 (Fine) | Ko'nchilik ustaxonasida xom terini eman tanini va tuz eritmasida 2 kun ivitib olinadi. | Ritsarlik charm nimchalari, botinkalar, qurol qinlari, ot egarlari va kamarlar. |
| `ITEM_TREE_RESIN` | Tabiiy Daraxt Qatroni / Smola | Organik Yelim | Tier 1 (Common) | Qarag'ay va archa tanalarini maxsus nov bilan tirnab, idishlarga to'plab olinadi. | Mash'alalar, olovli qamal o'qlari, suv o'tkazmaydigan qayiq qoplamalari. |
| `ITEM_BEESWAX` | Tabiiy Asalari Mumi | Organik Mum | Tier 1 (Common) | Shahar asalarixonasi uyalaridan asal ajratib olingandan keyingi qoldiq mum. | Cherkov shamlari, xat muhrlari mumi, ipni mumlash va po'latni zangdan asrash. |
| `ITEM_CRUDE_OIL` | Qora Neft / Qoramoy (Petroleum)| Yonuvchi Suyuqlik | Tier 2 (Fine) | Botqoqlik va tekislikdagi neft sizib chiqqan quduqlardan chelaklab olinadi. | Katapulta yonuvchi xumlari, mudofaa xandaklariga quyib o't qo'yish. |
| `ITEM_QUICKSILVER` | Alkimyoviy Tozalangan Simob | Suyuq Metall | Tier 3 (Masterwork) | Alkimyogar qozonida kinovar rudasini bug'latib kondensatsiya qilish orqali olinadi. | Oltinni tozalash, oynalarga kumush qoplash va oliy darajali sehrli eliksirlar. |

#### 13.4.4. O'simliklar, Ekinlar va Dorivor Giylar (Plants, Crops, Herbs & Seeds)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_CROP_WHEAT` | Oltin Boshoqli Bug'doy | Donli Ekin | Tier 1 (Common) | Ekin maydonlariga ekilib, 72 o'yin soatida pishib yetilgach o'roq bilan o'rib olinadi. | Tegirmonda maydalanib oliy navli oq un va shahar aholisining asosiy noniga aylanadi. |
| `ITEM_CROP_BARLEY` | Pivo Pishirish Karpasi | Donli Ekin | Tier 1 (Common) | Dala polizlarida unumdor tuproqda yetishtiriladi (tez o'suvchi ekin). | Qovoqxona pivo pishirish qozonida solod tayyorlash va otlar uchun yem. |
| `ITEM_CROP_RYE` | Qattiq Qishki Javdar (Rye) | Donli Ekin | Tier 1 (Common) | Qirovli va sovuq tog' etaklarida ham o'sa oladigan bardoshli qishki don. | Qora javdar to'yimli noni va uzoq saqlanuvchi armiya quruq kulchalari. |
| `ITEM_CROP_CARROT` | Shirin Dala Sabzisi (Carrot) | Ildizmeva | Tier 1 (Common) | Poliz maydonlaridan yig'ib olinadi yoki yovvoyi o'tloqlardan topiladi. | Xom yeyish, otlarni qo'lga o'rgatish va go'shtli quyuq sho'rvalarga qo'shish. |
| `ITEM_CROP_CABBAGE` | Qishki Qalin Karam (Cabbage) | Sabzavot | Tier 1 (Common) | Namlik yuqori bo'lgan sovuq yerlarda ekilib, yirik bosh bo'lib yetiladi. | Qishki bochkalarda tuzlash, qishloq dimlamasi va fuqarolar immunitetini oshirish. |
| `ITEM_CROP_POTATO` | To'yimli Dala Kartoshkasi | Ildizmeva | Tier 1 (Common) | Yengil qumloq tuproqlarda ekiladi, bitta ekilgan ildizdan 4-6 dona hosil olinadi. | Qovurish, o'choqda pishirish, garnir va qahraton qishda ocharchilikdan qutqarish. |
| `ITEM_FRUIT_APPLE` | Shirin Qizil Olma (Apple) | Meva | Tier 1 (Common) | Qishloq mevali bog'laridagi olma daraxtlari shoxlaridan silkitib terib olinadi. | Xom meva sifatida kayfiyatni ko'tarish, olma sharbati va mevali piroglar pishirish. |
| `ITEM_BERRY_FOREST` | O'rmon Malina va Maymuni | Yovvoyi Mevalar | Tier 1 (Common) | Yoz oylarida o'rmon chetlari va butazorlardan qo'l bilan terib yig'iladi. | Dala ovqatlanishi, quritilgan qishki zaxira va mevali asal sharbati tayyorlash. |
| `ITEM_HERB_BLOODWORT` | Qon To'xtatuvchi Dalachoy | Dorivor Giyoh | Tier 1 (Common) | Quyoshli tepaliklar va o'tloqlardan yozda o'roq yoki pichoq bilan teriladi. | Tabibxonada qon ketishini darhol to'xtatuvchi tibbiy malham va damlamalar. |
| `ITEM_HERB_FROSTMINT` | Sovuqqa Qarshi Tog' Kiyiko'ti| Dorivor Giyoh | Tier 2 (Fine) | Tog'li qorli hududlar va tosh yoriqlaridan qiyinchilik bilan terib olinadi. | Gipotermiyani yenguvchi qaynoq isituvchi choy va nafas yo'llari damlamasi. |
| `ITEM_HERB_CHAMOMILE` | Shifobaxsh Dala Moychechagi | Dorivor Giyoh | Tier 1 (Common) | Daryo bo'ylari va tekisliklardan bahor oylarida erkin teriladi. | Yuqumli kasalliklar, ich ketishi va jarohat infeksiyalariga qarshi damlama. |
| `ITEM_FUNGI_DEATHCAP` | Qora Zaharli Qo'ziqorin | Zaharli Zamburug'| Tier 2 (Fine) | Qorong'i nam g'orlar va chirigan to'nkalar ostidan qo'lqop bilan teriladi. | Qotillar xanjari uchun kuchli zahar tayyorlash va dushman quduqlarini zaharlash. |
| `ITEM_FUNGI_PORCINI` | O'rmon Oq Qo'ziqorini | Yeyiladigan Qo'ziqorin| Tier 1 (Common) | Eman va qarag'ay o'rmonlarida kuzgi yomg'irlardan keyin mo'l bo'lib unib chiqadi.| Qovurilgan taomlar, quritib qishga saqlash va to'yimli qo'ziqorin sho'rvasi. |
| `ITEM_CROP_GARLIC` | O'tkir Sarimsoqpiyoz (Garlic) | Dorivor Sabzavot | Tier 1 (Common) | Sabzavot polizlarida yetishtiriladi yoki o'rmon chetlarida yovvoyi holda o'sadi. | Go'shtni buzilmasdan uzoq saqlash, qora vabo epidemiyasiga qarshi tabiiy qalqon. |

#### 13.4.5. Yeguliklar, Konservalar va Ichimliklar Katalogi (Food, Preserves & Beverages)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_FOOD_RAW_MILK` | Yangi Sog'ilgan Sigir Suti | Xom Yegulik | Tier 1 (Common) | Shahar sut fermasida boqilayotgan sigirlarni chelakka sog'ib olinadi. | Bolalar va bemorlar ozuqasi, pishloq ivitish va sariyog' tayyorlash. |
| `ITEM_FOOD_EGG` | Yangi Qishloq Tovuq Tuxumi | Xom Yegulik | Tier 1 (Common) | Qushxona va kataklardagi tovuq inlaridan har kuni ertalab terib olinadi. | Pishirish, qandolatchilik piroglari va xom holda to'yimlilik manbasi. |
| `ITEM_FOOD_RAW_BEEF` | Xom Qoramol Go'shti | Xom Go'sht | Tier 1 (Common) | Qassobxonada boqilgan buqa yoki sigir so'yilganda 12-16 bo'lak tushadi. | O'choqda qovurish, dudlash, tuzlash va qirollik go'shtli taomlari tayyorlash. |
| `ITEM_FOOD_RAW_VENISON` | Xom Kiyik Go'shti (Venison) | Yovvoyi Go'sht | Tier 2 (Fine) | O'rmonda kiyik yoki yelik kamon bilan ovlanganda 6-8 bo'lak tushadi. | Qal'a zodagonlari sevimli ovqati, kam yog'li qovurma va quritilgan go'sht. |
| `ITEM_FOOD_RAW_PORK` | Xom Cho'chqa Go'shti | Xom Go'sht | Tier 1 (Common) | Cho'chqaxonada boqilgan cho'chqa so'yilganda ko'p miqdorda yog' va go'sht olinadi.| Qazi-qarta, dudlangan bekon, to'yimli qishki qovurmalar va chiroq yog'i. |
| `ITEM_FOOD_RAW_TROUT` | Yangi Daryo Foreli Balig'i | Xom Baliq | Tier 1 (Common) | Daryo va ko'llarga to'r tashlagan yoki qarmoq tutgan baliqchilar tomonidan tutiladi.| Olovda pishirish, baliq sho'rva tayyorlash va qayin tutunida dudlash. |
| `ITEM_FOOD_FLOUR` | Oliy Navli Yanchilgan Oq Un | Oziq Xomashyosi | Tier 1 (Common) | Suv yoki shamol tegirmonida bug'doy donalarini yanchish orqali qoplarda olinadi. | Nonvoyxonaning asosiy xomashyosi; non, pirog va qattiq kulchalar pishirish. |
| `ITEM_FOOD_SALT` | Qazib Olingan Osh Tuzi | Oziq Xomashyosi | Tier 1 (Common) | Tuz konlari va quruq sho'rxoklardan cho'kich bilan qazib olinadi. | Go'sht va baliqlarni chirishdan saqlash (konservalash) hamda taom lazzati. |
| `ITEM_FOOD_BREAD` | O'choqda Pishgan Qarsildoq Non| Tayyor Taom | Tier 1 (Common) | Nonvoyxona tosh pechida un, suv, xamirturush va tuzdan 15 daqiqada pishiriladi. | Fuqarolarning kundalik ochligini qondirish ($+35$ Hunger) va bazaviy ozuqa. |
| `ITEM_FOOD_COOKED_MEAT` | Olovda Pishirilgan Go'sht | Tayyor Taom | Tier 2 (Fine) | Gulxan yoki o'choqda har qanday xom go'shtni qovurish orqali tayyorlanadi. | Yuqori to'yimlilik ($+65$ Hunger), jismoniy kuchni tiklash va quvvat berish. |
| `ITEM_FOOD_VEGETABLE_STEW`| Qaynoq Sabzavotli Dala Ragusi| Tayyor Taom | Tier 1 (Common) | Qozonda kartoshka, sabzi, karam va piyozni suvda qaynatib tayyorlanadi. | Issiq ozuqa ($+45$ Hunger, $+20$ Warmth), qishda tanani isitish va kasallikni qaytarish. |
| `ITEM_FOOD_MEAT_PIE` | Qal'a Qirollik Go'shtli Pirogi| Elita Taom | Tier 3 (Masterwork) | Nonvoyxona pechida nozik xamir ichiga kiyik go'shti, qo'ziqorin va ziravorlar solib pishiriladi.| Oliy to'yimlilik ($+90$ Hunger), fuqaro kayfiyatiga $+25$ baxt berish. |
| `ITEM_FOOD_ROAST_POTATO` | Qovurilgan Qishloq Kartoshkasi| Tayyor Taom | Tier 1 (Common) | O'choq tovada kartoshkani cho'chqa yog'ida qizartirib qovuriladi. | Tez tayyor bo'luvchi ommaviy taom ($+40$ Hunger), dehqonlarning sevimli ozuqasi. |
| `ITEM_FOOD_BERRY_TART` | Shirin O'rmon Rezavor Pirogi | Shirinlik | Tier 2 (Fine) | Xamir ichiga malina, maymunjon va asal solib pishiriladi. | Aholining ruhiyatini ko'tarish ($+15$ Morale) va bayramona to'kinlik. |
| `ITEM_FOOD_SALTED_MEAT` | Yog'och Bochkada Tuzlangan Go'sht| Uzoq Muddatli Zaxira| Tier 2 (Fine) | Go'shtni ko'p miqdorda tuz bilan qorishtirib, zich eman bochkalariga bosiladi. | 60 o'yin kuni davomida aynimaydi; qishki qahraton va qamallarda asosiy ozuqa. |
| `ITEM_FOOD_SMOKED_FISH` | Qayin Tutunida Dudlangan Baliq| Uzoq Muddatli Zaxira| Tier 2 (Fine) | Dudxona binosida daryo balig'ini qayin qipiqlari tutunida 8 soat dudlab olinadi.| 45 o'yin kuni davomida aynimaydi; armiya yurishlarida qulay ixcham yegulik. |
| `ITEM_FOOD_DRIED_FRUIT` | Quyoshda Quritilgan Meva Qoqi| Uzoq Muddatli Zaxira| Tier 1 (Common) | Olma va rezavorlarni quritish so'rilarida quyosh ostida quritib olinadi. | 90 o'yin kuni davomida buzilmaydi; uzoq safarlarda darmondori manbasi. |
| `ITEM_FOOD_HARDTACK` | Uzoq Safar Qattiq Kulchasi | Armiya Zaxirasi | Tier 1 (Common) | Suv va undan tuzsiz qattiq qilib pishirilib, quyoshda toshdek qotiriladi. | Aynish muddati cheksiz ($\infty$ kun); qamal vaqtida askarlar ochdan o'lmasligi uchun. |
| `ITEM_DRINK_WATER_JUG` | Toza Quduq Suvi Ko'zasi | Ichimlik | Tier 1 (Common) | Shahar tosh qudug'idan sopol ko'zaga toza yerosti suvini to'ldirib olinadi. | Chanqoqni qondirish ($+50$ Thirst), shahar epidemiyalarining oldini olish. |
| `ITEM_DRINK_ALE` | Oltin Arpa Qishloq Eli | Spirtli Ichimlik | Tier 1 (Common) | Pivo pishirish qozonida arpa solodi, suv va xamirturushni achitib olinadi. | Chanqoqni bosadi, fuqarolarning mehnat charchog'ini kamaytiradi va kayfiyat beradi. |
| `ITEM_DRINK_STOUT` | Quyuq Qora Ritsarlar Qora Pivasi| Kuchli Ichimlik | Tier 2 (Fine) | Qovurilgan qora arpa va toza buloq suvidan maxsus bochkalarda tindirib olinadi. | Qahraton sovuqda tana haroratini $+15^\circ\text{C}$ ga ko'taradi va jasorat beradi. |
| `ITEM_DRINK_MEAD` | Tozalangan Tabiiy Asal Sharbati| Qirollik Ichimligi| Tier 3 (Masterwork) | Asalari mumi ajratilgan sof asalni suv va xushbo'y tog' giyohlari bilan achitiladi. | Aristokratlar va Hukmdor ziyofatlari ichimligi; jismoniy charchoqni butunlay yuvadi. |
| `ITEM_DRINK_HERBAL_TEA` | Isituvchi Tog' Dorivor Choyi | Shifobaxsh Ichimlik| Tier 1 (Common) | Qaynoq suvga kiyiko'ti, dalachoy va moychechak solib damlanadi. | Shamollash, yo'tal va titroqni davolovchi xalq tabobati ichimligi. |

#### 13.4.6. Asboblar va Mehnat Qurollari Katalogi (Tools & Implements)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_TOOL_PICKAXE_STONE` | Ibtidoiy Tosh Cho'kich | Mehnat Quroli | Tier 1 (Common) | Qo'lda 2 dona tosh va 1 dona tayoqdan dastgohsiz yasaladi. | Yer yuzasidagi dala toshlari, gil va ko'mirni sekin sur'atda qazish ($Speed = 1.0\times$). |
| `ITEM_TOOL_PICKAXE_IRON` | Temir Konchi Cho'kichi | Mehnat Quroli | Tier 2 (Fine) | Temirchilik dastgohida 3 temir quyma va 2 yog'och dastadan yasaladi. | Qattiq granit, temir va kumush rudalarini tez qazish ($Speed = 2.2\times$). |
| `ITEM_TOOL_PICKAXE_STEEL` | Zich Po'lat Cho'kich | Mehnat Quroli | Tier 3 (Masterwork) | Saroy temirxonasida 3 po'lat quyma va sayqallangan eman dastadan yasaladi. | Bazalt, marmar, oltin va olmos tomirlarini osonlik bilan o'yish ($Speed = 3.5\times$). |
| `ITEM_TOOL_PICKAXE_MITHRIL`| Qadimiy Afsonaviy Mitril Cho'kich| Afsonaviy Qurol | Tier 4 (Legendary) | Runik bosqonda 3 mitril quyma va daxma qora yog'ochidan bolg'alanadi. | Dunyodagi har qanday blokni soniyada qazish ($Speed = 6.0\times$) va mutlaqo sinmaslik. |
| `ITEM_TOOL_AXE_STEEL` | O'rmonchi Po'lat Boltasi | Mehnat Quroli | Tier 2 (Fine) | Temirchilik dastgohida 2 po'lat quyma va mustahkam yog'och dastadan yasaladi. | Yo'g'on eman va qora archalarni tez yiqitish, o'tin tilish ($Speed = 2.8\times$). |
| `ITEM_TOOL_SHOVEL_IRON` | Qazuvchi Temir Belkuragi | Mehnat Quroli | Tier 2 (Fine) | Temirxonada 1 dona temir plastina va uzun yog'och dastadan yasaladi. | Loy, qum, shag'al va qor uyumlarini bir zumda tozalash hamda chuqur xandaklar qazish. |
| `ITEM_TOOL_SCYTHE_IRON` | Dehqon O'tkir O'rog'i | Qishloq Xo'jaligi | Tier 2 (Fine) | Temirxonada kavisli temir tig' va uzun ikki tutqichli yog'ochdan yasaladi. | Bug'doy, arpa va zig'ir maydonlarini keng polosa bilan bir zumda o'rib olish. |
| `ITEM_TOOL_SMITH_HAMMER` | Temirchi Og'ir Bosqon Bolg'asi| Hunarmandchilik | Tier 2 (Fine) | Temirxonada og'ir to'rtburchak po'lat bosh va qisqa dasta bilan quyiladi. | Dastgohda qurollar, sovutlar, mixlar va taqalarni bolg'alab shakl berish. |
| `ITEM_TOOL_CARPENTER_SAW` | Duradgor Quyi Arrasi va Randasi| Hunarmandchilik | Tier 2 (Fine) | Duradgorxonada tishli po'lat polosa va yog'och ramkadan yig'iladi. | Xodalarni silliq taxtalarga tilish, quti va mebellarning chetini tekislash. |
| `ITEM_TOOL_MASON_CHISEL` | Tosh Yo'nuvchi Po'lat Qalami | Hunarmandchilik | Tier 2 (Fine) | Temirxonada toblangan o'tkir qalamcha po'latdan quyiladi. | Dag'al dala toshlarini silliq me'moriy tosh bloklar va bezakli naqshlarga aylantirish. |
| `ITEM_TOOL_TANNER_KNIFE` | Teri Shilib Tozalash Pichog'i | Hunarmandchilik | Tier 1 (Common) | Temirxonada ikki tutqichli yarimoy shaklidagi yupqa tig'dan yasaladi. | Terining ostki yog' qatlamini qirib tozalash va ko'nchilikka tayyorlash. |
| `ITEM_TOOL_WEAVER_SPINDLE` | To'quvchi Yog'och Urchug'i | Hunarmandchilik | Tier 1 (Common) | Duradgor stolida silliq qayindan yo'nib, og'ir tosh halqa o'rnatiladi. | Zig'ir va jun tolalarini mustahkam to'qish iplariga aylantirish. |

#### 13.4.7. Qurollar va Qamal O'q-Dorilari Katalogi (Weapons & Siege Ammunition)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_WEAPON_SHORT_SWORD` | Piyodalar Temir Qisqa Qilichi| Bir Qo'lli Qurol | Tier 1 (Common) | Temirxonada 2 temir quyma, teri bog'ich va yog'och sopdan yasaladi. | Tor qasr yo'laklarida tezkor sanchuvchi va kesuvchi zarbalar berish. |
| `ITEM_WEAPON_LONG_SWORD` | Ritsarlik Po'lat Uzun Qilichi | Bir/Ikki Qo'lli | Tier 2 (Fine) | Temirxona bosqonida 3 po'lat quyma va kumush simli sop bilan toblanadi. | Ochiq maydonda keng qulochli kuchli zarbalar va zirhli raqiblarga qarshi kurash. |
| `ITEM_WEAPON_GREATSWORD` | Ikki Qo'lli Qasos Qilichi | Og'ir Ikki Qo'lli | Tier 3 (Masterwork) | Saroy ustaxonasida 5 po'lat quyma va qo'rg'oshin muvozanat toshi bilan yasaladi.| Bir zarbada dushmanning bir nechta askarini safini buzish va otliq ritsarlarni qulatish. |
| `ITEM_WEAPON_DAGGER_DAMASCUS`| Damashq Po'lat Yashirin Xanjari| Yashirin Qurol | Tier 4 (Legendary) | Maxfiy usta tomonidan Damashq po'latidan o'yib yasaladi. | Orqadan berilgan zarbada $4.0\times$ kritik zarar yetkazish va zirh oralarini teshish. |
| `ITEM_WEAPON_PIKE` | Safdorlar Uzun Temir Nayzasi | Nayza / Masofaviy | Tier 1 (Common) | 1 temir uchlik va 3 metrli eman xodasidan ustaxonada yig'iladi. | Dushman otliqlarini to'xtatuvchi yengilmas nayzadorlar mudofaa devorini hosil qilish. |
| `ITEM_WEAPON_HALBERD` | Qal'a Gvardiyasi Alebardasi | Bolta-Nayza | Tier 2 (Fine) | 3 po'lat quyma va mustahkamlangan yog'och dastadan yasaladi. | Otdan yulqib tushirish, qalqonlarni yorib tashlash va og'ir chopuvchi zarba. |
| `ITEM_WEAPON_WAR_MACE` | Zirh Maydalovchi Og'ir Gurzi| Maydalovchi Qurol| Tier 2 (Fine) | Qolipga quyilgan qirrali og'ir quyma temir bosh va qalin sopdan yasaladi. | Raqibning temir dubulg'a va ko'krak zirhini bukib, miya chayqalishi va suyak sindirish. |
| `ITEM_WEAPON_WARHAMMER` | Ikki Tomonlama Urush Bolg'asi | Maydalovchi/Teshuvchi| Tier 2 (Fine) | Bir tomoni to'mtoq bolg'a, ikkinchi tomoni o'tkir tumshuqli po'lat qurol. | Og'ir ritsarlik sovutlarini teshib o'tish va qalqonlarni sindirish. |
| `ITEM_WEAPON_HUNTING_BOW` | Qisqa Yog'och Ov Kamoni | Masofaviy Qurol | Tier 1 (Common) | Qayin yog'ochi va zig'ir payidan qo'lda yasaladi. | Kiyik va parrandalarni ovlash hamda dastlabki o'rmon qaroqchilaridan himoyalanish. |
| `ITEM_WEAPON_LONGBOW` | Uelslik Usta Uzun Kamoni | Og'ir Kamon | Tier 3 (Masterwork) | Qora archa (Yew) xodasi va quritilgan hayvon payidan 30 kunda bukiladi. | 150 metr masofadan dushman safiga o'q yog'dirish va zanjir sovutlarni teshib o'tish. |
| `ITEM_WEAPON_CROSSBOW` | Temir Mexanik Arbalet | Mexanik Otuvchi | Tier 2 (Fine) | Po'lat prujina yoyi, eman qo'ndog'i va mexanik tepkidan yig'iladi. | Maxsus kamonchilik mahoratisiz ham og'ir zirhlarni qisqa masofadan teshib o'tish. |
| `ITEM_WEAPON_ARBALEST` | Qamal Og'ir Stankali Arbaleti| Qamal Quroli | Tier 3 (Masterwork) | Zich po'lat va aylanma richagli richag bilan jihozlangan ulkan otgich. | Devor tepasidagi snayperlik va dushman qalqonlarini bir zarbada parchalab tashlash. |
| `ITEM_AMMO_ARROW_IRON` | Temir Uchli Standart Kamon O'qi| O'q-Dori | Tier 1 (Common) | Duradgor stolida 1 taxta, 1 temir bo'lagi va qush patidan 10 dona yasaladi. | Barcha kamonlar uchun standart otuvchi o'q. |
| `ITEM_AMMO_BOLT_STEEL` | Po'lat Uchli Arbalet Bolt O'qi| O'q-Dori | Tier 2 (Fine) | Temirxonada og'ir po'lat uchlik va qisqa qalin xodachadan 10 dona quyiladi. | Arbaletlar uchun og'ir zirh teshuvchi to'g'ri chiziqli o'q. |
| `ITEM_AMMO_ARROW_FIRE` | Qatronli Olovli Qamal O'qi | Yonuvchi O'q | Tier 2 (Fine) | O'q uchiga qatronli latta o'rab, oltingugurt kukuni sepib yasaladi. | Dushmanning yog'och mudofaa minoralari, uylari tomi va qamal texnikasini yoqish. |
| `ITEM_AMMO_TREBUCHET_BOULDER`| Trebuchet Silliq Tosh Yadrosi | Qamal Snaryadi | Tier 2 (Fine) | Tosh yo'nuvchi maydonida 100 kg og'irlikdagi dumaloq monolit tosh yo'niladi. | Qal'a devorlari va tosh minoralarni uzoq masofadan parchalab teshish. |
| `ITEM_AMMO_PITCH_POT` | Yonuvchi Qoramoy Xumi | Qamal Snaryadi | Tier 2 (Fine) | Sopol xum ichiga qora neft, oltingugurt va smola to'ldirib quyiladi. | Katapultadan otilganda yerga urilib sinadi va butun maydonga o'chmas olov yoyadi. |

#### 13.4.8. Sovutlar va Qalqonlar Master Katalogi (Complete Armor Sets & Shields)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_ARMOR_CLOTH_TUNIC` | Oddiy Kanop Ko'ylak va Ishton | Mato Kiyim | Tier 1 (Common) | To'quvchilik stolida 3 dona zig'ir matodan tikiladi. | Boshlang'ich kiyim; sovuqdan $+5$ himoya beradi, zarbaga qarshi himoyasi yo'q. |
| `ITEM_ARMOR_GAMBESON` | Qalin Paxtali va Junli Jilet | Yumshoq Zirh | Tier 1 (Common) | To'quvchilikda 4 jun mato va zig'ir ipdan qalin qilib qaviladi. | O'tmas zarbalarni yumshatish (Blunt $-15\%$) va zanjir sovut ostidan kiyish. |
| `ITEM_ARMOR_LEATHER_CUIRASS`| Qattiq Qaynatilgan Charm Nimcha| Charm Zirh | Tier 2 (Fine) | Ko'nchilik ustaxonasida qalin charm va temir qisqichlardan tikiladi. | Yengil harakatchanlikni saqlagan holda kesuvchi zarbalardan himoya (Slash $-25\%$). |
| `ITEM_ARMOR_LEATHER_BOOTS` | Qalin Charm Ovchi Botinkasi | Charm Oyoq kiyim| Tier 1 (Common) | Ko'nchilikda 2 dona yumshoq oshlangan charm va kanop ipdan yasaladi. | Qor va loyda tez yurish, yiqilish jarohatlarini kamaytirish. |
| `ITEM_ARMOR_CHAINMAIL_HAUBERK`| Zanjirli Halqa Temir Ko'ylak | Halqali Zirh | Tier 2 (Fine) | Temirxonada 8,000 dona mayda temir halqachalarni bir-biriga kiygizib to'qiladi. | Qilich va boltalar zarbasini qaytarish (Slash $-45\%$, Pierce $-20\%$). |
| `ITEM_ARMOR_CHAINMAIL_COIF` | Zanjirli Temir Bosh Qalpog'i | Halqali Bosh kiyim| Tier 2 (Fine) | Temirxonada 2,000 mayda halqachadan bo'yin va boshni o'rovchi qilib yasaladi.| Bo'yin va boshni kesuvchi qilich zarbalaridan asrash. |
| `ITEM_ARMOR_CHAINMAIL_CHAUSSES`| Zanjirli Halqa Zirhli Paypoq| Halqali Oyoqlik | Tier 2 (Fine) | Temirxonada halqachalarni oyoq shaklida to'qib, charm tasmalar bilan mahkamlanadi.| Oyoq qismini kesuvchi qilich va o'q zarbalaridan himoya qilish. |
| `ITEM_ARMOR_BRIGANDINE` | Po'lat Plastinkali Brigantina | Qoplama Zirh | Tier 3 (Masterwork) | Qalin movut yoki charm nimcha ichiga to'rtburchak po'lat plastinalar mixlab yasaladi.| Yuqori darajadagi himoya (Slash $-60\%$, Pierce $-50\%$) va qulay harakat. |
| `ITEM_ARMOR_PLATE_CUIRASS` | Shohona To'liq Po'lat Ko'krak Zirhi| To'liq Po'lat Zirh| Tier 3 (Masterwork) | Saroy temirxonasida 6 po'lat quyma va charm tasmalar bilan shakl berib toblanadi.| Har qanday kamon o'qi va qilich zarbasini to'liq sirpantirib qaytarish. |
| `ITEM_ARMOR_GREAT_HELM` | Ritsarlik Yopiq Buyuk Dubulg'asi| Po'lat Bosh kiyim| Tier 3 (Masterwork) | 3 po'lat quyma va nafas olish tuynuklari bilan toblanib yasaladi. | Bosh qismiga tushadigan har qanday halokatli kritik zarbani 100% qaytarish. |
| `ITEM_ARMOR_PLATE_GAUNTLETS`| Bo'g'inli Po'lat Qo'lqoplar | Po'lat Qo'llik | Tier 3 (Masterwork) | Po'lat plastinchalarni charm qo'lqop ustiga bo'g'inma-bo'g'in qirqib mixlanadi.| Qo'llarni kesilishdan asrash va musht zarbasini og'ir temir qurolga aylantirish. |
| `ITEM_ARMOR_PLATE_GREAVES` | Po'lat Tizza va Boldirlik Zirh | Po'lat Oyoqlik | Tier 3 (Masterwork) | Po'lat plastinalarni boldir va tizzaga moslab egib yasaladi. | Pastdan beriladigan nayza va bolta zarbalaridan oyoqlarni butunlay himoya qilish. |
| `ITEM_ARMOR_PLATE_SABATONS` | Po'lat Qoplamali Jangovar Etik| Po'lat Etak | Tier 3 (Masterwork) | Harakatlanuvchi po'lat qipiqlari bilan etikka biriktiriladi. | Oyoq kaftini qopqonlar, qamal tikanlari va o'tkir toshlardan asrash. |
| `ITEM_SHIELD_BUCKLER` | Yengil Yog'och Temir Bukler | Kichik Qalqon | Tier 1 (Common) | Yog'och doira markaziga temir quyma gumbazcha o'rnatib yasaladi. | Qilich zarbalarini tezkor aks ettirish (Parry) va duel janglari. |
| `ITEM_SHIELD_ROUND` | Qayinzor Dumaloq Viki Qalqoni | O'rta Qalqon | Tier 1 (Common) | Qayin taxtalarini birlashtirib, chetiga xom teri qoplab yasaladi. | Piyodalar jangida qilich va bolta zarbalarini to'liq yutish. |
| `ITEM_SHIELD_KITE` | Ritsarlik Tomchi Qalqoni | Uzun Qalqon | Tier 2 (Fine) | Eman yog'ochi, qalin charm va temir chetliklar bilan yasaladi. | Otliq ritsarlar va piyodalarning yelkasidan tizzasigacha bo'lgan qismini o'qlardan asrash. |
| `ITEM_SHIELD_HEATER` | Qirollik Gerbli Isituvchi Qalqon| Uchburchak Qalqon| Tier 2 (Fine) | Po'lat bilan qoplangan eman taxtalaridan uchburchak shaklda tayyorlanadi. | Qilich zarbalarini qaytarishda qulaylik va saroy gerbini namoyish qilish. |
| `ITEM_SHIELD_PAVISE` | Kamonchilar Katta Shahar Pavizasi| Katta Statsionar | Tier 3 (Masterwork) | Og'ir eman taxtalari va orqa suyanchiq tirgovichidan yasaladi. | Yerga tirgab qo'yilib, uning ortida kamonchilar bemalol o'q dori to'ldirishi uchun. |

#### 13.4.9. Mob Droplari va Yirtqich O'ljalari Katalogi (Mob Drops & Hunting Trophies)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_DROP_WOLF_FANG` | Qora Bo'ri Jag'i va Qoziq Tishi| Yirtqich O'ljasi | Tier 1 (Common) | O'rmon qora bo'risi (Direwolf) o'ldirilganda 85% ehtimol bilan 2-4 dona tushadi. | O'tkir tig'li qurol runasi (`RUNE_RAZOR_EDGE`) yasash va qabila marjonlari. |
| `ITEM_DROP_BEAR_SKULL` | Tog' Ayig'i Bosh Suyagi Bo'lagi | Maxluq Tufeyli | Tier 2 (Fine) | Tog' qo'ng'ir ayig'i yengilganda 60% ehtimol bilan 1 dona tushadi. | Titratuvchi zarb runasi (`RUNE_STAGGER_CONCUSSION`) va ritsarlik dubulg'asi bezagi. |
| `ITEM_DROP_BOAR_TUSK` | Yovvoyi To'ng'iz Egri Qoziq Tishi| Yirtqich O'ljasi | Tier 1 (Common) | O'rmon yovvoyi to'ng'izi ovlanganda 75% ehtimol bilan 2 dona tushadi. | O'rmon qulashi runasi (`RUNE_TIMBER_FALL`) va qattiq suyak dastalar tayyorlash. |
| `ITEM_DROP_RAVEN_FEATHER` | Qora Qarg'a Qanot Pati | Qush O'ljasi | Tier 1 (Common) | O'rmon qarg'alari kamon bilan urib tushirilganda 100% ehtimol bilan 4-8 dona tushadi.| Shamol yirtuvchi kamon runasi (`RUNE_WINDPIERCER`) va o'qlarni patlash. |
| `ITEM_DROP_EAGLE_FEATHER` | Tog' Burguti Parvoz Pati | Qush O'ljasi | Tier 2 (Fine) | Baland qoyalardagi burgut inlari yoki burgut ovlanganda 50% ehtimol bilan tushadi. | Qush pati qadami runasi (`RUNE_FEATHER_STRIDE`) va shohona shlyapa patlari. |
| `ITEM_DROP_DEER_ANTLER` | Qora Kiyik Ko'p Shoxli Shoxi | O'rmon O'ljasi | Tier 1 (Common) | O'rmon kiyigi ovlanganda 80% ehtimol bilan 1 juft tushadi. | Qurol dastalari, yelim qaynatish va qasr devori ovchilik ko'rgazmasi bezagi. |
| `ITEM_DROP_BURROWER_CLAW` | Yerosti Kalamushi O'tkir Tirnog'i| G'or Maxluqi | Tier 1 (Common) | $-30\text{m}$ dan chuqur g'or kalamushlari o'ldirilganda 70% ehtimol bilan tushadi. | Seysmik tebranishli qazish runasi (`RUNE_SEISMIC_STRIKE`) tayyorlash. |
| `ITEM_DROP_GLOW_SAC` | Nurli Lichinka Shilliq Pufagi | G'or Maxluqi | Tier 2 (Fine) | Qorong'i shaxta shiftidagi yaltiroq lichinkalar o'ldirilganda 90% tushadi. | Geologik soflik runasi (`RUNE_VEIN_PURITY`) va qorong'ida yonuvchi eliksirlar. |
| `ITEM_DROP_CARAPACE` | Qoya Toshbaqasi Kosasi Plastinasi| Qattiq Qobiq | Tier 2 (Fine) | Chuqur yerosti toshbaqalari yengilganda 100% ehtimol bilan 3-5 dona tushadi. | Po'lat qobig'i sovut runasi (`RUNE_IMPENETRABLE_WARD`) va qalqon qoplamalari. |
| `ITEM_DROP_SPIDER_VENOM` | Zaharli G'or O'rgimchagi Tikani | Zaharli O'lja | Tier 2 (Fine) | O'rgimchak uyalari tozalanganda har bir maxluqdan 65% ehtimol bilan tushadi. | Qasos tikanlari runasi (`RUNE_BARBED_THORNS`) va xanjarlar uchun halokatli zahar. |
| `ITEM_DROP_FIRE_HIDE` | Magmatik Kaltakesak Yonar Terisi| Olovli O'lja | Tier 3 (Masterwork) | Magma ko'llari bo'yidagi olov kaltakesaklaridan 50% ehtimol bilan tushadi. | Ajdaho qalqoni olov himoyasi runasi (`RUNE_DRAGON_WARD`) va o'tga chidamli kiyim. |
| `ITEM_DROP_FROST_PAW` | Qutb Oq Bo'risi Qalin Panjasi | Qorli O'lja | Tier 2 (Fine) | Tundra va qorli qoyalardagi oq bo'rilar yengilganda 70% ehtimol bilan tushadi. | Muz yurar qadam runasi (`RUNE_FROST_TREAD`) va issiq qishki etiklar tikish. |
| `ITEM_DROP_BANDIT_INSIGNIA` | Qaroqchilar Boshlig'i Tamg'asi| Inson O'ljasi | Tier 2 (Fine) | Qaroqchilar lageri boshlig'i (Bandit Chief) mag'lub etilganda 100% tushadi. | Urush tovoni runasi (`RUNE_PLUNDER_SPOILS`) va noib huzurida mukofot olish. |

#### 13.4.10. Runalar, Sehrli Asoslar va Noyob Artefaktlar (Runes, Sockets & Sovereign Relics)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_RUNE_BLANK_SLATE` | Bo'sh Tosh Runa Plitasi | Sehrli Asos | Tier 1 (Common) | Tosh yo'nuvchi stolida 1 dona silliq kvars yoki marmar plitasini kesib olinadi. | Barcha darajali runalarni o'yib yozish uchun zarur bo'lgan bo'sh poydevor plitasi. |
| `RUNE_SEISMIC_STRIKE` | Vibratsion Qazish Runasi (I-III)| Cho'kich Runasi | Tier 2-3 (Darajali) | Sehrgarlar stolida kvars plita, lapislazuli va kalamush tirnog'idan yasaladi. | Qazish tezligini oshirish va shaxta shifti o'pirilish xavfini keskin pasaytirish. |
| `RUNE_VEIN_PURITY` | Geologik Soflik Runasi (I-III) | Cho'kich Runasi | Tier 2-3 (Darajali) | Sehrgarlar stolida marmar plita, oltin qumi va nurli lichinka pufagidan yasaladi.| Chiqindi tosh shlakini yo'qotib, sof ruda va butun javohirlar tushishini oshirish. |
| `RUNE_PRECISION_QUARRY` | Monolit Blok Kesish Runasi (I-III)| Cho'kich Runasi | Tier 2-3 (Darajali) | Sehrgarlar stolida granit plita, kvars kristali va toshbaqa tirnog'idan yasaladi.| Toshlarni mayda shag'alga aylantirmasdan silliq monolit blok holida ajratish. |
| `RUNE_LIVING_TEMPER` | Yashovchan Metall Runasi (I-III)| Barcha Asboblar | Tier 2-3 (Darajali) | Alkimyo laboratoriyasida temir plita, simob, daraxt shirasi va bo'ri yog'idan yasaladi.| Asbobning eskirishini 85% gacha sekinlashtirish va turgan joyida o'zini ta'mirlash. |
| `RUNE_TIMBER_FALL` | O'rmon Qulashi Runasi (I-III) | Bolta Runasi | Tier 2-3 (Darajali) | Sehrgarlar stolida ohaktosh plita, lapislazuli va to'ng'iz tishidan yasaladi. | Daraxt tagidan kesilganda butun daraxtni bir maromda qulatib, o'tin to'plamiga aylantirish. |
| `RUNE_REAPERS_HARVEST` | Dehqon Barakoti Runasi (I-III) | O'roq Runasi | Tier 2-3 (Darajali) | Sehrgarlar stolida loy plitasi, oltin qumi va ari qanotidan yasaladi. | Keng poliz maydonidagi hosilni bir zarbada o'rib, o'rniga avtomatik urug' ekish. |
| `RUNE_RAZOR_EDGE` | Olmos Damli Tig' Runasi (I-III)| Qilich / Nayza | Tier 2-3 (Darajali) | Sehrgarlar stolida po'lat plita, olmos va qora bo'ri jag' suyagidan yasaladi. | Dushmanning og'ir temir zirhini 45% gacha teshib, halokatli zarar yetkazish. |
| `RUNE_SMOLDERING_PYRE` | Magma Alangi Runasi (I-III) | Qilich / Nayza | Tier 2-3 (Darajali) | Alkimyogar o'chog'ida bazalt, oltingugurt va magmatik qo'ng'iz qobig'idan yasaladi.| Dushmanga 10 soniyalik olov berish va shamol orqali dushman safiga olov yoyish. |
| `RUNE_STAGGER_CONCUSSION` | Titratuvchi Zarb Runasi (I-III)| Gurzi / Qilich | Tier 2-3 (Darajali) | Sehrgarlar stolida qo'rg'oshin plita, lapislazuli va ayiq bosh suyagidan yasaladi.| Dushman muvozanatini 100% buzib, 3 soniyaga qurolsizlantirish va tiz cho'ktirish. |
| `RUNE_PLUNDER_SPOILS` | Urush Tovoni Runasi (I-III) | Qilich / Bolta | Tier 2-3 (Darajali) | Sehrgarlar stolida kumush plita, oltin qumi va qaroqchilar tamg'asidan yasaladi. | Mag'lub bo'lgan dushmandan butun qurol, tillo va sovutlar tushishini 50% ga oshirish. |
| `RUNE_WINDPIERCER` | Shamol Yirtuvchi Runasi (I-III)| Kamon / Arbalet | Tier 2-3 (Darajali) | Sehrgarlar stolida yengil kvars, lapislazuli va qarg'a patlaridan yasaladi. | O'qlar parvozida shamol va gravitatsiyani yo'qotib, 160m gacha to'g'ri otish. |
| `RUNE_BALLISTIC_PIERCE` | Yoruvchi Ballistika Runasi (I-III)| Arbalet / Kamon | Tier 2-3 (Darajali) | Sehrgarlar stolida obsidian, temir qirindisi va ilon tishidan yasaladi. | Dushman qalqonini parchalab, uning ortidagi yana 2 ta dushmanga to'liq zarar berish. |
| `RUNE_IMPENETRABLE_WARD` | Po'lat Qobig'i Runasi (I-III) | Barcha Sovutlar | Tier 2-3 (Darajali) | Sehrgarlar stolida po'lat plita, lapislazuli va toshbaqa kosasidan yasaladi. | Barcha kesuvchi, sanchuvchi va maydalovchi zararlarni 40% gacha qaytarish. |
| `RUNE_DRAGON_WARD` | Ajdaho Qalqoni Runasi (I-III) | Ko'krak Sovut / Qalqon| Tier 2-3 (Darajali) | Alkimyo laboratoriyasida loy plita, oltingugurt va kaltakesak terisidan yasaladi.| Qamal katapultalari toshlari, olovli o'qlar va portlash zararini 75% kamaytirish. |
| `RUNE_FEATHER_STRIDE` | Qush Pati Qadami Runasi (I-III)| Botinka | Tier 2-3 (Darajali) | Sehrgarlar stolida pumza plita, lapislazuli va burgut patlaridan yasaladi. | Qal'a devorlari va tog' qoyalaridan sakraganda yiqilish zararini 95% pasaytirish. |
| `RUNE_ABYSSAL_LUNG` | G'avvos Nafasi Runasi (I-III) | Dubulg'a | Tier 2-3 (Darajali) | Alkimyo stolida ko'k shisha, kumush sim va suv iloni qovurg'asidan yasaladi. | Daryo va ko'llarda suv ostida uzoq vaqt nafas olib, suv tubida jang qilish. |
| `RUNE_BARBED_THORNS` | Qasos Tikanlari Runasi (I-III)| Ko'krak Sovut / Qalqon| Tier 2-3 (Darajali) | Sehrgarlar stolida mis plita, temir qirindisi va o'rgimchak tikanlaridan yasaladi.| Yaqindan zarba bergan dushmanga uning zararasining 55% ini aks ettirish. |
| `RUNE_FROST_TREAD` | Muz Yurar Qadam Runasi (I-III)| Botinka | Tier 2-3 (Darajali) | Sehrgarlar stolida marmar plita, muz kristallari va qor bo'risi panjasidan yasaladi.| Muz ustida 100% sirpanmaslik va qalin qorda harakat tezligini to'liq saqlash. |
| `RUNE_SPECTRAL_PHANTOM` | Arvoh Zirhi Afsonaviy Runasi | Noyob Boss Runasi| Tier 4 (Non-craftable)| Faqat Zulmat Onasi (Deep Cave Boss) mag'lub etilganda 100% o'lja sifatida tushadi.| HP 20% dan tushganda 4 soniyaga barcha jismoniy zarbalarga daxlsiz arvohga aylanish. |
| `RUNE_THUNDER_WRATH` | Momaqaldiroq Qahri Runasi | Noyob Boss Runasi| Tier 4 (Non-craftable)| Faqat Qoya Kolossi (Mountain Boss) yengilganda 100% kafolatlangan o'lja bo'lib tushadi.| Momaqaldiroqda har 4-chi og'ir zarbada osmondan haqiqiy chaqmoq tushirib portlatish. |
| `RUNE_VOID_VISION` | Qora Shaxta Ko'zi Runasi | Daxma Relikviyasi | Tier 4 (Non-craftable)| Faqat -300m chuqur qadimiy katakomba sandiqlaridan 10% ehtimol bilan topiladi. | Qorong'ulikda devor ortidagi qimmatbaho oltin va olmos tomirlarini 12m dan ko'rish. |
| `RUNE_AEGIS_VANGUARD` | Vassallar Qalqoni Runasi | Qasr O'ljasi | Tier 4 (Non-craftable)| Faqat raqib Lord Valdemar Qasri xazinasini egallaganda 25% ehtimol bilan o'lja bo'ladi.| Qalqon blokida Hukmdor orqasidagi 10 askarni ham qoplovchi ko'rinmas gumbaz hosil qilish. |
| `RUNE_SMELT_STRIKE` | Zulmat Eruvchisi Runasi | Daxma Relikviyasi | Tier 4 (Non-craftable)| Faqat Magmatik Bedrock Xarobalari sandiqlaridan 8% ehtimol bilan chiqadi. | Har qanday rudani qazib olgan zahoti to'g'ridan-to'g'ri quyma metallga aylantirish. |
| `RUNE_SOUL_TETHER` | Jon Rishtasi Runasi | Noyob Boss Runasi| Tier 4 (Non-craftable)| Faqat Muz Qanoti (Frost Wyvern Boss) yengilganda 100% o'lja bo'lib tushadi. | Tekkan dushmanni 5 soniyaga muzlatib yerga mixlash va uning tezligini o'yinchiga berish. |
| `RING_SOVEREIGN_AUTHORITY` | Hukmdorlik Qudrati Uzugi | Hukmdor Taqinchog'i| Tier 4 (Non-craftable)| Faqat qadimiy imperator daxmasidagi qabr toshidan topiladi (yasalmaydi). | Barcha fuqarolarning itoatsizlik xavfini yo'qotish va soliq tushumini +20% ga oshirish. |
| `RING_EARTHWARDEN` | Yer Qo'riqchisi Uzugi | Hukmdor Taqinchog'i| Tier 4 (Non-craftable)| Faqat -250m chuqurlikdagi Geologik Xazina sandig'idan topiladi (yasalmaydi). | Shaxta o'pirilish xavfini butunlay bartaraf etish va jismoniy charchoqni 40% sekinlatish. |
| `RING_ETERNAL_VIGIL` | Abadiy Uyg'oqlik Uzugi | Hukmdor Taqinchog'i| Tier 4 (Non-craftable)| Faqat Qoya Kolossi daxmasidan yagona nusxada o'lja qilinadi (yasalmaydi). | Hukmdorning uyquga bo'lgan ehtiyojini butunlay yo'qotib, kechasi qorong'ida ko'rish. |
| `AMULET_PHOENIX_CREST` | Qaqnus Toji Tumori | Hukmdor Tumori | Tier 4 (Non-craftable)| Faqat Magma Titani o'ldirilganda uning yuragidan tushadi (yasalmaydi). | Hukmdor jangi chog'ida halokatli zarba olsa, uni to'liq HP bilan shu zahoti tiriltirish. |
| `TALISMAN_FROSTWARD` | Qirov Qalqoni Tumori | Hukmdor Tumori | Tier 4 (Non-craftable)| Faqat Muz Qanoti g'oridagi muzlagan sandiqdan olinadi (yasalmaydi). | Qahraton qish bo'ronlarida gipotermiya va sovuq qotish zararini 100% bloklash. |
| `TOME_ROYAL_RALLY` | Qirollik Safarbarligi Qadimiy Tomi| Suveren Kitob | Tier 4 (Non-craftable)| Faqat Buyuk Imperiya Kutubxonasi xarobasidan topiladi (yasalmaydi). | Shahar mudofaasi vaqtida barcha qurolli fuqarolar jangovar kuchini +35% oshirish. |
| `TOME_ANCIENT_ARCHITECT` | Qadimiy Me'mor Farmonlari Tomi | Suveren Kitob | Tier 4 (Non-craftable)| Faqat birinchi tosh sobor poydevori daxmasidan topiladi (yasalmaydi). | Barcha tosh va g'ishtli me'moriy inshootlar qurilish vaqtini 50% ga qisqartirish. |
| `TOME_TAX_HARVESTER` | Oltin G'azna Hisob-Kitoblari Tomi| Suveren Kitob | Tier 4 (Non-craftable)| Faqat mag'lub etilgan Savdogarlar Gildiyasi seyfidan olinadi (yasalmaydi). | Karvon bojlari va bozor savdosi tushumlaridan olinadigan shahar daromadini +50% qilish. |
| `TOME_IRON_DISCIPLINE` | Po'lat Intizom Qonunlari Tomi | Suveren Kitob | Tier 4 (Non-craftable)| Faqat Warlord Valdemar shaxsiy kabinetidan o'lja qilinadi (yasalmaydi). | Shahar garnizoni askarlarining qochish ehtimolini (Desertion) qat'iy 0% ga tushirish. |
| `TOME_TACTICAL_RETREAT` | Taktik Chekinish va Qutqaruv Tomi| Suveren Kitob | Tier 4 (Non-craftable)| Faqat Qadimiy O'rmon Ruhoniysi qabridan olinadi (yasalmaydi). | Qamalda Hukmdor hushidan ketsa, uni 100% kafolat bilan kasalxonaga qutqarib olib kelish. |

#### 13.4.11. Maishiy, Yoritish va Logistika Buyumlari Katalogi (Household, Containers & Logistics)

| Buyum ID | O'zbekcha / Inglizcha Nomi | Kategoriya / Turi | Sifat / Tier | Qayerdan Olinadi / Tushishi (Source & Drop Matrix) | Asosiy Vazifasi / Foydalanishi |
|---|---|---|---|---|---|
| `ITEM_UTIL_TORCH` | Qatronli Yog'och Mash'ala | Yoritgich | Tier 1 (Common) | Qo'lda 1 yog'och tayoq va 1 ko'mir yoki daraxt smolasidan dastgohsiz yasaladi. | Qorong'i g'orlar va shahar ko'chalarini 12 metr radiusda yoritish. |
| `ITEM_UTIL_LANTERN` | Oynali Mis Kerosin Fonari | Sifatli Yoritgich | Tier 2 (Fine) | Temirxonada 1 mis plastina, 1 shisha panel va o'simlik moyidan yig'iladi. | Shamol va yomg'irda o'chmaydigan, uzoq yonuvchi yorug'lik manbasi. |
| `ITEM_CONTAINER_CHEST_SMALL` | Kichik Yog'och Sandiq | Saqlash Sandig'i | Tier 1 (Common) | Duradgor stolida 8 dona yog'och taxta va 4 temir mixdan yasaladi. | 16 katakli shaxsiy yoki shahar ombori zaxiralarini saqlash sig'imi. |
| `ITEM_CONTAINER_CHEST_BANDED`| Temir Halqali Mustahkam Sandiq| Saqlash Sandig'i | Tier 2 (Fine) | Duradgorxonada 8 taxta va 4 temir plastinadan qulflanadigan qilib yasaladi. | 32 katakli o'g'rilardan himoyalangan mustahkam buyumlar ombori. |
| `ITEM_CONTAINER_ICEBOX` | Muzlatgich Sovuq Kiler Qutisi| Oziq-Ovqat Saqlash| Tier 2 (Fine) | Duradgor stolida taxtalar, qalay qoplama va muz kristallari bilan yig'iladi. | Ichidagi go'sht, sut va mevalarning chirish vaqtini 10 barobarga sekinlashtirish. |
| `ITEM_CONTAINER_TOOL_RACK` | Devoriy Qurollar va Asboblar Javoni| Inventar Saqlash | Tier 2 (Fine) | Duradgorlik dastgohida 6 taxta va 8 temir ilgakdan devorga o'rnatiladi. | Asboblarning saqlanishi va ularning eskirgan holatini avtomatik tiklash. |
| `ITEM_CONTAINER_ROYAL_VAULT` | Qasr G'aznasi Og'ir Po'lat Seyfi| Xazina Seyfi | Tier 3 (Masterwork) | Qal'a temirxonasida 8 po'lat quyma va murakkab usta qulflari bilan quyiladi. | 64 katakli qirollik xazinasi, oltin tangalar va qimmatbaho artefaktlarni saqlash. |
| `ITEM_LOGISTICS_HANDCART` | Ikki G'ildirakli Qo'l Aravachasi| Logistika Vositalari| Tier 1 (Common) | Duradgor stolida 6 taxta, 2 yog'och g'ildirak va temir o'qdan yasaladi. | Fuqaroning bir vaqtda 250 kg tosh va xodalarni ko'tarib tashish imkoniyati. |
| `ITEM_LOGISTICS_HORSE_WAGON`| To'rt G'ildirakli Og'ir Ot Aravasi| Katta Logistika | Tier 2 (Fine) | Duradgorxonada eman xodalari, 4 temir gardishli g'ildirak va egar bilan yasaladi.| Bir safarda 1,500 kg tovarlarni uzoq konlardan markaziy omborga tashish. |
| `ITEM_UTIL_ROPE` | Qalin Kanop Arqon Bog'lami | Yordamchi Vosita | Tier 1 (Common) | To'quv dastgohida 4 bog'lam zig'ir tolasini eshib o'rash orqali yasaladi. | Chuqur shaxtalarga tushish, ko'tarma kranlar va dushmanni bog'lab tutqun qilish. |
| `ITEM_UTIL_FLINT_TINDER` | O't Yoqish Chaqmoqtoshi va Qov | Dala Ashyosi | Tier 1 (Common) | Dala toshlari orasidan chaqmoqtosh va quruq daraxt qovini birlashtirib olinadi. | Ochiq maydonda darhol gulxan yoqish va muzlagan tanani isitish. |
| `ITEM_UTIL_BANDAGE` | Tibbiy Toza Zig'ir Bog'ichi | Tibbiyot | Tier 1 (Common) | Toza oq zig'ir matosini qaynoq suvda qaynatib, tasmalar qilib o'raladi. | Qon ketish statusini darhol to'xtatish va yaralarni infeksiyadan asrash. |
| `ITEM_UTIL_HEALING_SALVE` | Tabiiy Shifobaxsh Asal Malhami | Tibbiyot | Tier 2 (Fine) | Tabibxonada dalachoy ekstrakti, toza asal va cho'chqa yog'idan tayyorlanadi. | Yaralarning bitishini 3 barobar tezlashtirish va suyak og'rig'ini qoldirish. |
