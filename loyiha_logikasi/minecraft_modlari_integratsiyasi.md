...
- [x] **3D Blender 5.2 Modellar**: Jami 27 ta to'liq modellashtirilgan va import qilingan GLB 3D aktivlar (`water_wheel.glb`, `millstone.glb`, `trip_hammer.glb` qo'shildi).
